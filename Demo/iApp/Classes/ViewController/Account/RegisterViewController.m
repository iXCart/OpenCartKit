...
- (void)saveAction:(id)sender
{
    ...
    //@step
    NSString* firstname = [params stringValueForPath:@"firstname"];
    NSString* lastname = [params stringValueForPath:@"lastname"];;
    NSString* email = [params stringValueForPath:@"email"];;
    NSString* password = [params stringValueForPath:@"password"];;
    NSString* confirm = [params stringValueForPath:@"confirm"];;
    
    NSString* telephone = [params stringValueForPath:@"telephone"];;
    NSString* address_1 = [params stringValueForPath:@"address_1"];;
    
    NSString* city = [params stringValueForPath:@"city"];;
    NSString* postcode = [params stringValueForPath:@"postcode"];;
    NSString* country_id = [params stringValueForPath:@"country_id"];;
    NSString* zone_id = [params stringValueForPath:@"zone_id"];;
...
- (NSDictionary*) getRowDef:(NSIndexPath*)indexPath
{
    ...
    //@step force set to immutable
    item = [NSDictionary dictionaryWithDictionary:item];
    return item;
}
